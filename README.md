...
1. Person index. It represents the identity of pedestrians. Everyone has unique index.
2. Camera index. It represents the camera number, and each camera has unique index.
